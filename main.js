/*
ID: ID CLASSICO DA TABELLA DATI
CONTENT: CI0' CHE C'E' SCRITTO NEL POST
MEDIA: LINK IMMAGINE POST
AUTHOR: AUTORE POST
    NAME: NOME AUTORE
    IMAGE: LINK IMMAGINE AUTORE
LIKE: NUMERO DI LIKE;
CREATED: DATA DI QUANDO è STATOCREATO IL POST
*/
const posts = [
    {
        "id": 1,
